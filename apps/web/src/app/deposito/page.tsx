    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 px-4 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        <div className="w-full max-w-lg">
          <div className="rounded-2xl border border-amber-100 bg-white px-8 py-10 shadow-xl dark:border-gray-200 dark:bg-white">
            <div className="mb-8 text-center">
              <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-amber-500 shadow-lg">
                <Warehouse className="h-7 w-7 text-white" />
              </div>
              <h1 className="text-2xl font-bold text-gray-900">Depósito – Elegir local</h1>
              <p className="mt-1 text-sm text-gray-600">Hola {user?.firstName}, elige el depósito</p>
            </div>
            {loadingLocations ? (
              ...
              <div className="space-y-3">
                {locations.map((loc) => (
                  <button
                    ...
                    className="flex w-full items-center gap-4 rounded-xl border border-gray-200 bg-gray-50 px-5 py-4 text-left hover:border-amber-300 hover:bg-amber-50 dark:border-gray-300 dark:bg-gray-100"
                  >
                    <MapPin className="h-5 w-5 shrink-0 text-amber-600" />
                    <div className="min-w-0 flex-1">
                      <p className="truncate font-semibold text-gray-900">{loc.name}</p>
                      <p className="text-sm capitalize text-gray-600">Depósito</p>
                    </div>
      ...
      <div className="w-full max-w-md">
        <div className="rounded-2xl border border-amber-100 bg-white px-8 py-10 shadow-xl">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-gray-500">Mesas y comandas del depósito</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 rounded-lg p-1 text-gray-400 hover:text-gray-600"
                  tabIndex={-1}
                >
