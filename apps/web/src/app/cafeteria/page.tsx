        ...
        <div className="w-full max-w-lg">
          <div className="rounded-2xl border border-slate-200/60 bg-white px-8 py-10 shadow-xl dark:border-gray-200 dark:bg-white">
            <div className="mb-8 text-center">
              ...
              <h1 className="text-2xl font-bold text-gray-900">Cafetería – Elegir sucursal</h1>
      ...
      <div className="w-full max-w-md">
        <div className="rounded-2xl border border-slate-200/60 bg-white px-8 py-10 shadow-xl">
          ...
          <div className="mb-8 text-center">
            ...
            <h1 className="text-2xl font-bold text-gray-800">Cafetería</h1>
            <p className="mt-2 text-sm text-gray-500">Solo Cafetería, Admin o Gerente</p>
            <p className="mt-1 text-xs text-gray-400">Pantalla de pedidos de cafetería</p>
          </div>
          <form onSubmit={handleLogin} className="form-login-fields space-y-5">
            <div>
              <label htmlFor="cafe-email" className="mb-2 block text-sm font-medium text-gray-700">
                Correo
              </label>
              <input
                id="cafe-email"
            ...
            <div>
              <label htmlFor="cafe-password" className="mb-2 block text-sm font-medium text-gray-700">
                Contraseña
              </label>
